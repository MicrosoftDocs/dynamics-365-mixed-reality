...
A Dynamics 365 Guides device license must be assigned to a shared Microsoft Entra user account. A shared account is just like a regular user account except it's shared by all 

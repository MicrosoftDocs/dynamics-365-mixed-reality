...
5. On the **Security Role: Dynamics 365 Guides Restricted Operator** page, on the **Custom Entities** tab, in the rows for the **Guide** entities, select the dots in the second column (as shown in the following illustration) to change the Read privileges from the **Organization** level to the **User** level. When you've finished, select **Save and Close** at the top of the page.

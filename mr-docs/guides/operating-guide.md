...
|![Outline buttons)](media/outline-button.png "Outline button")|Outline|Go to the Outline page. Use the Outline page to quickly navigate around your guide. Here’s what the Outline page looks like for Example Guide: ![HoloLens Outline page)](media/outline-page-hololens.png "HoloLens Outline page")| 

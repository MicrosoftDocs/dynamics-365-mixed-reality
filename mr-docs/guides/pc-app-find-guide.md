...
2. Open the **Home** page, enter a name in the filter box, and then select the **Filter** button.
    ...
    > - Navigating the folder structure through the **All** tab or the folder breadcrumbs above the filter box. Note that folders never appear on the **Recent** tab. To learn how to create folders with the Guides model-driven app, select the **Learn about folders** button on the **Home** page.

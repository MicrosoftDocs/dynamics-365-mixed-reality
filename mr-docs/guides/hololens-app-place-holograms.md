...
2. Use gaze and gestures to place the 3D part hologram over its counterpart in the real world. For information on manipulating holograms, see the [Manipulate holograms](#manipulate-holograms) section later in this article.

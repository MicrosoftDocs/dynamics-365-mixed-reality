...
> [!IMPORTANT]
> - The August 9, 2022 release introduced a new setting that improves video transcoding. If the PC app detects a hardware transcoding failure, it automatically forces software encoding instead. If the software encoding is successful, the XXX setting is automatically updated to switch off hardware encoding. 

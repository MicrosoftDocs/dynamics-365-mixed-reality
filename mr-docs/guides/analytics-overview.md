...
- Integrated into your own custom workflows using the Power Platform

This operations data, which includes information about time spent on each step and whether an operator completed a guide, is stored in Microsoft Dataverse tables just like your Dynamics 365 Guides content. These tables make it easy to analyze guide usage across your organization or gain insights into process efficiency by using the Guides Analytics Power BI templates or by building your own customer integrations outside of Dynamics 365 Guides.

...
|B|![Follow button](media/follow-button.png "Follow button")|Follow|Have the Step card follow you or lock it to a location.|Guides includes a feature called Follow mode. Wherever you look, the Step card follows your gaze so you never have to worry where your instructions are. When you turn off Follow mode, the card stays where it is. You can just grab the card at any time by using the navigation bar to move it wherever you like. |

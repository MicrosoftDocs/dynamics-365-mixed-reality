...
This article provides a version history for Microsoft Dynamics 365 Guides features. For the most recent features, see [What's new in Dynamics 365 Guides](new.md). 

...
|---|---|---|
|PC app and HoloLens app| Dynamics 365 Guides| [Buy and deploy Dynamics 365 Guides](setup.md)<p>You can also [sign up for a free trial subscription](setup.md).</p> |

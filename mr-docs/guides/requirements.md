...
## Services, apps, features, and requirements

The following table lists services, apps, and features and the products required to purchase or use those services, apps, or features.

| Service/feature | Product required| Learn more |
|---|---|---|
|Purchase a subscription and assign licenses|Azure Active Directory (Azure AD) account<br><br>You need an Azure AD account for each licensed user. Users also need Azure AD to sign in to the app.</li></ul> | [Get started with Azure AD](/azure/active-directory/fundamentals/active-directory-whatis) |
|PC app and HoloLens app| Dynamics 365 Guides| [Buy and deploy Dynamics 365 Guides](setup.md)<p><p>-Or-<p>[Sign up for a free trial subscription](setup.md)</p> |
...
|Analytics dashboard| Power BI Desktop app<p><p>**Note:** Power BI Desktop is [available as a free download](https://powerbi.microsoft.com/desktop/).</p> | [Learn more about Power BI](https://powerbi.microsoft.com/desktop/) |


Internet access is required to download the app and use all its features for both PC and [!include[pn-hololens](../includes/pn-hololens.md)]. | |

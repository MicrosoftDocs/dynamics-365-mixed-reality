...
|---|---|---|
|Purchase a subscription and assign licenses|Azure Active Directory (Azure AD) account<br><br>You need an Azure AD account for each licensed user. Users need Azure AD to sign in to the app.</li></ul> | [Get started with Azure AD](/azure/active-directory/fundamentals/active-directory-whatis) |

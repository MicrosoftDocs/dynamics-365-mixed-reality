...
If a guide has been deactivated in Guides, you can reactivate it. When you reactivate a guide, it immediately becomes available for authors to open or edit in the PC app. You can deactivate a guide or permanently delete it if you're sure that you no longer need it.

If a packaged guide has been deactivated in Guides, you can reactivate it. When you reactivate a packaged guide, it immediately becomes available for HoloLens users to view or for [authors to download it](package-a-guide.md#download-a-packaged-guide-in-the-model-driven-app).

You can also activate, deactivate, or delete specific guide content (video, image, or 3D part).

  > [!TIP]
  > If you're an author and want to deactivate a guide, see [deactivate a guide or guide content (video, image, or 3D part)](pc-app-deactivate-guide.md). If you want to deactivate a packaged guide, see [deactivate a packaged guide.](package-a-guide.md#manage-a-packaged-guide-in-the-pc-app)

...
> [!IMPORTANT]
> The Dynamics 365 Guides HoloLens and PC apps released on November 8, 2021 require the April 1, 2021 or later version of the Microsoft Dataverse solution (version 700 or later). [Learn more about which solutions work with which applications](admin-apps-solution-compatibility.md). Features might be missing or disabled if a solution older than 700 is installed. See the feature table below to determine if a new feature requires a solution update.
>

...
> [!IMPORTANT]
> On April 1, 2020, Microsoft will release a **mandatory** update to the Dynamics 365 Guides solution. Future Dynamics 365 Guides app releases after April 1 will require this solution version and will not work with older versions. Work with your admin to update the solution and apps in early April so you can continue using the PC and HoloLens apps without interuption.

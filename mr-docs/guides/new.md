...
> [!IMPORTANT]
> Guides Dataverse solution version 700.1.0.1, which will be released on January 25, 2022, is a foundational change for key features in upcoming Dynamics 365 Guides releases. When solution version 700.1.0.1 is released, updated versions of the PC and HoloLens apps will be available as well and **will require the 700.0.0.1 or newer solution.** To install solution version 700.1.0.1, you’ll need to first install solution version 700.0.0.1 if you haven’t already. 
> 

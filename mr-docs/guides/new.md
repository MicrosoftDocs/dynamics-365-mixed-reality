...
The April 1 update addresses accessibility issues and adds some quality improvements. See the [Release plan wave 2 page](https://docs.microsoft.com/en-us/dynamics365-release-plan/2019wave2/mixed-reality/dynamics365-guides/planned-features) for details.

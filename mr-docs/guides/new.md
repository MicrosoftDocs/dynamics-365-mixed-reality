...
> [!IMPORTANT]
> Guides Dataverse solution version 7.1, which will be released on January 25, 2022, is mandatory if you want to continue to use the latest PC and HoloLens apps. As of the 7.1 release, the PC and HoloLens apps will require the 700 or later Dataverse solution. This Dataverse solution is a foundational change for key features in upcoming Dynamics 365 Guides releases. If you choose not to update the solution and remain on the version 600 solution and apps, there's no impact. 
>

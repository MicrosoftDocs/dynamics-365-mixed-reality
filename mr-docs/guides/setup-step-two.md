...
> [!IMPORTANT]
> Dynamics 365 Guides data will be stored in the Common Data Service solution. Before anyone can create and use guides, however, you [must assign appropriaate roles to all Dynamics 365 Guides users](). 

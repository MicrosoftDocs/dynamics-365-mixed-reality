...
>[!NOTE]
>**Known issue with Asset Management integration**. Asset Management integration with Dynamics 365 Guides is currently not working due to a bug. We'll update this page as soon as the bug has been fixed.

...
>[!NOTE]
>**Known issue with Asset Management integration**. Asset Management integration with Dynamics 365 Guides doesn't currently work because of a bug. We will update this page as soon as the bug has been fixed.

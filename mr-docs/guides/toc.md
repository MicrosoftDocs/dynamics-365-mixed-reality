...
#### [Strategy for segregating guides between organizational entities](gxp-guidance/strategy-for-segregating-guides-between-organizational-entities.md)
#### [Strategy for user control and access](gxp-guidance/strategy-for-user-control-and-access.md)
#### [Strategy for access control and IAM](gxp-guidance/strategy-for-access-control-and-iam.md)
#### [Strategy for content and 3D Toolkit ownership](gxp-guidance/strategy-for-content-and-3d-toolkit-ownership.md)
#### [Strategy for versioning guides](gxp-guidance/strategy-for-versioning-guides.md)
#### [Strategy for integrations to QMS/LMS](gxp-guidance/strategy-for-integrations-to-qmslms.md)
...
##### [Setup HoloLens devices](gxp-guidance/hololens-devices.md#setup-hololens-devices)
##### [User-based versus device-based setup](gxp-guidance/hololens-devices.md#user-based-versus-device-based-setup)
##### [Maintain HoloLens devices](gxp-guidance/hololens-devices.md#maintain-hololens-devices)
##### [Store HoloLens devices in cabinets with charging capabilities](gxp-guidance/hololens-devices.md#store-hololens-devices-in-cabinets-with-charging-capabilities)
##### [Track your HoloLens devices](gxp-guidance/hololens-devices.md#track-your-hololens-devices)
#### [Power Platform Environments](gxp-guidance/power-platform-environments.md)
##### [Setup Power Platform environments](gxp-guidance/power-platform-environments.md#setup-power-platform-environments)
##### [Maintain Power Platform environments](gxp-guidance/power-platform-environments.md#maintain-power-platform-environments)
### Governance
...
##### [Application validations](gxp-guidance/purpose-of-validation-and-traceability.md#application-validations)
#### [Maintenance of the qualified and validated status](gxp-guidance/maintenance-of-the-qualified-and-validated-status.md)
### [Recommendations for Organizational Change Management](gxp-guidance/recommendations-org-change-management.md)

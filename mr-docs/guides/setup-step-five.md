---
author: Mamaylya
description: Optional step 5 in setting up Dynamics 365 Guides, which includes adding additional user accounts
ms.author: mamaylya
ms.date: 01/28/2020
...
# Dynamics 365 Guides setup Step 5: Add additional user accounts (optional)

...
2. If the pop-up doesn't appear, use the start gesture to open the **Start** menu. For help with gestures, see [Gestures for authoring or navigating in Dynamics 365 Guides](authoring-gestures-HL2.md).

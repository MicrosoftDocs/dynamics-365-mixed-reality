...
- **Circular code anchor**. When you use a circular code anchor, you align a guide by gazing at a printed circular code anchor that is attached to a physical object in the real world. (Circular code anchors are referred to as printed anchors in earlier versions of [!include[pn-dyn-365-guides](../includes/pn-dyn-365-guides.md)].)

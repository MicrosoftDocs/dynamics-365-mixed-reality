...
10. In step 3 of the wizard, select **Import** to import the picture you took in step 8, and then drag it to the **Import anchor placement photo** bix. Select **Next** to move to the next step.

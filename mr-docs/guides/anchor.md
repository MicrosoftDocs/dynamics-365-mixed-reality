...
4. Drag the 3D model from the **3D parts** tab to the **Assign digital anchor** box. This assigns the 3D model as your digital anchor. Select **Next** when you're ready to move to the next step.

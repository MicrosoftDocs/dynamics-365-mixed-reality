...
3. In step 1 of the wizard, select **Download QR Code** to create a PDF file named **Guides-QRCodeAnchor**. This file includes the anchor that you will print in step 5.

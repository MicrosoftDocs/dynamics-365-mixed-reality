...
8. Follow one of these steps:
    ...
    - If the users are already in the list, skip ahead to step 10 to assign user roles.
...
12. Select the check box(es) for the appropriate role(s) for the selected user(s), and then select **Save**.

...
You can [place and size a trigger](hololens-app-place-manipulate-holograms) just like any other hologram in the HoloLens app. When placing a trigger, keep the following in mind:

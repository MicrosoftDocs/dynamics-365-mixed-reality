...
> [!NOTE]
> Tools in the **Selection** menu such as **Select Environments**, **Select Similar**, and **Select By Max Size** can be very useful for quickly selecting multiple occurrences to delete.

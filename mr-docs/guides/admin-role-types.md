# About the Restricted Author and Restricted Operator roles in Dynamics 365 Guides
...
Restricted Operator roles provide an extra layer of control. The following table describes the privileges that each role grants.
...
The Restricted Author and Restricted Operator roles are used to limit access to guides. Users who are assigned the Restricted Author and Restricted Operator roles 
...
For more information on the Restricted Author and Restricted Operator roles, see 
...
> [!IMPORTANT]
> If you followed the instructions in the [Try or buy, and deploy Dynamics 365 Guides](setup.md) topic when you set up Dynamics 365 Guides, any users that you added were 

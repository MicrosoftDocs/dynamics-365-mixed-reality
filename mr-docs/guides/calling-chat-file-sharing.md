...
1. If you receive a chat message while you're on a call, a red circle appears on the **Chat** button, and the **Chat** button animates. Select the **Chat** button to open the chat. 
    ...
    A new Chat window appears to the right of the Meetings window. A recording button appears in the upper-left corner of the Chat window to let you know that the chat is being recorded. 

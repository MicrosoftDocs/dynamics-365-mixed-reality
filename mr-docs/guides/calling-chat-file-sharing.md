...
3. In the holographic keyboard that appears, enter your message, or use the **Microphone** button to dictate a message. Select the **Send** button (or press the Return key on the holographic keyboard) when you're ready to send the message. 
    ...
    If a remote collaborator shares a file or page link, the file or page automatically opens in a new window in the Dynamics 365 Guides user's space. The Dynamics 365 Guides user can move this window wherever they want or size it directly with their hands. 

...
Yes. Activity table (PhoneCalls table) privileges are mandatory for users trying to sign in to both apps. Users must have the following seven privileges to be able to sign in:

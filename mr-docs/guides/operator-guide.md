...
>[!NOTE]
>If you're a Dynamics 365 Guides author, you can assign a role so a user can't edit a guide. For more information, see [Assign an Author or Operator role for a user](assign-role.md).

...
Ready to get started with Microsoft Dynamics 365 Guides? Follow these three steps to download the apps, and then start creating!
...
|[![Download PC app button.](media/download-pc-app.jpg "Download PC app button")](setup-step-three.md#install-the-pc-authoring-app)|[![Launch HoloLens app button.](media/launch-hololens-app.jpg "Launch HoloLens app button")](setup-step-three.md#open-the-hololens-2-app)|[![View best practices button.](media/download-pc-app.jpg "View best practices button")](great-guide.md)|

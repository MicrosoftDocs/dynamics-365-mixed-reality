...
Ready to get started with Microsoft Dynamics 365 Guides? Follow these three steps to jumpstart your learning curve after [installing the solution](setup-step-one.md). 
...
|[![Download PC app button.](media/download-pc-app.jpg "Download PC app button")](setup-step-three.md#download-the-pc-app)|[![Launch HoloLens app button.](media/launch-hololens-app.jpg "Launch HoloLens app button")](setup-step-three.md#launch-the-hololens-app)|[![View best practices button.](media/view-best-practices.jpg "View best practices button")](great-guide.md)|

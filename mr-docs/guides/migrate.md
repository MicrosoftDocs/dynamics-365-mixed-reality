...
- Both the source instance and the destination instance must use Dynamics 365 Guides solution version 400.0.0 or later. Make sure that the destination instance is on the same or newer version than the source instance.
...
5. Download the **ContentMigrationTool\_D365Guides\_v400.0.1.0.zip** folder by selecting the link in the **File Name** column. The file is automatically saved in your **Downloads** folder.
...
4. Go to the File Explorer location where you extracted the contents of the zipped folder, and then go to the **ContentMigrationTool\_D365Guides\_v400.0.1.0** \> **MigrationToolScripts** folder.

...
You can deactivate a guide or specific guide content (video, image, or 3D model) if you no longer need it. For more information, see [Deactivate a guide or specific guide content](pc-app-deactivate-guide.md). 

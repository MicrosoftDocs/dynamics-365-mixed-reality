...
>[!TIP]
>To find items that were recently added to the gallery, you can sort by name or by the date the item was added.<br>![Sort by list](media/sort-by-list.PNG "Sort by list")

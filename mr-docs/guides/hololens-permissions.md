...
2. Do the following:
    ...
    2. On the right side of the screen, under **Allow apps to access the camera on this device**, turn the setting to **On**.  
...
2. Do the following:
    ...
    2. On the right side of the screen, under **Allow apps to access the microphone on this device**, turn the setting to **On**. 

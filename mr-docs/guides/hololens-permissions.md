...
Version 7.0 of Dynamics 365 Guides introduced a new main menu and the ability to make a call from HoloLens. To use these new features, you must provide permissions to use HoloLens eye tracking, and the HoloLens camera and microphone.  

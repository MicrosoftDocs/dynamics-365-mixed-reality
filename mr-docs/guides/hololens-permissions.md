...
When you open the HoloLens app for the first time using Dynamics 365 Guides version 7.0, you're prompted to provide these permissions. If you choose not to provide permissions at that time, you can do it later as described in this article.

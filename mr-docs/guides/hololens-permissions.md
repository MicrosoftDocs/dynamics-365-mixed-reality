...
|Location|Optional. If you choose to allow location permissions, the location data is stored in Microsoft Dataverse and is displayed in the Calls form  [in the Guides model-driven app](call-logging.md).|

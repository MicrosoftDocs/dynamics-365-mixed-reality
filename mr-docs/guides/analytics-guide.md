...
3.	Is daily guide usage changing? 
    ...
    > [!TIP]
    > Use drill up/drill down. By default, this chart shows the session counts per day. However, you can use Power BI’s drill-up functionality to summarize session counts at the month or year level. [Learn more about how to use Drill mode in a visual in Power BI](https://docs.microsoft.com/power-bi/consumer/end-user-drill).   

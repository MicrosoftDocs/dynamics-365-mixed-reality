...
Yes. You can't share the layout directly from the Import Tool at this time, but you can copy the layout file and then use another tool, such as OneDrive, Microsoft Teams, or email to share it. 

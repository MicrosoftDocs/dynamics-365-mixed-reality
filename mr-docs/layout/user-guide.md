...
|  Item           |     Description                          |
|-----------------|------------------------------|
| **File format** | GLB file formats only, with the following limitations: <ul>Less than 5,000 polygons is recommended. </li><li>Texture size of 512 x 512 is recommended</ul> |

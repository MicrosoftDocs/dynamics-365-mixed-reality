...
|  Item           |     Description                          |
|-----------------|------------------------------|
| **File format** | <ul><li>FBX (version 7.5 or earlier) </li><li>OBJ </li><li>SKP (version 18 or earlier) </li><li>JT (versions 8 and 9) </li><li>STP, STEP (versions AP203 and AP214) </li><li>GLTF, GLB </li><ul><li>Version 2.0 </li><li>Input extensions: MSFT_texture_dds (supported); KHR_materials_pbrSpecularGlossiness (supported); MSFT_lod (currently not supported)</li><li>Output extensions: MSFT_packing_occlusionRoughnessMetallic (supported), MSFT_packing_normalRoughnessMetallic (supported); MSFT_texture_dds (currently not supported)</ul><li>ZIP</li> |

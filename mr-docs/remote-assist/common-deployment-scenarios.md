...
Learn more about how to [provide an external user with a one-time call link to join a Remote Assist call](set-up-teams.md#enable-someone-to-join-a-remote-assist-call-on-a-one-time-basis-using-the-teams-desktop-app).

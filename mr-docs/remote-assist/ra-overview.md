...
- Learn how to [deploy Teams application on PC or mobile](set-up-teams.md).
- (Optional) Learn how to [set up multi-tenant company deployments](multi-tenant-deployment.md)

...
2. Automatically post **call logs**, such as time, date, call duration, and the expert's name, and **files shared** into their Field Service work order at the end of a Remote Assist mobile call.

...
8. The technician can use the call controls toolbar to disable the video call and enter an audio-only call ![Screenshot of call controls button.](./media/call-controls-video.jpg), mute themselves on the call, turn on their speakers, or end the call. 

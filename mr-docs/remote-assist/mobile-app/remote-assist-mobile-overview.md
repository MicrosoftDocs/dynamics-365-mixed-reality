...
Dynamics 365 Remote Assist mobile is beneficial in scenarios where technicians may need physical access to confined or hard-to-reach spaces, or access to other mobile apps that are part of their organizations' workflows. With the availability and familiarity with mobile devices, technicians can use Remote Assist mobile during repairs and inspections with ease. Furthermore, Remote Assist mobile allows for easier broad-scale deployment in organizations.
...
- One-to-one video calling for three scenarios:
    ...
    1. A call between a Remote Assist mobile user and a Teams desktop user.
    1. A call between a Remote Assist mobile user and a Teams mobile user.

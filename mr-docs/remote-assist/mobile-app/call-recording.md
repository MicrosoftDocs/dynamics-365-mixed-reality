...
2. The technician receives a privacy notification with Microsoft’s privacy policy and a notice that call recording will begin. The notification can be dismissed.

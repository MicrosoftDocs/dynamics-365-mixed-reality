...
- Fix for call participants in a group call cannot post call content to a Dynamics 365 Field Service work order
...
- Incoming call notifications sound is not present when the device is on silent mode

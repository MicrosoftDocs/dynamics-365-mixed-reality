...
**HoloLens users must be on OS version 22H1 (Spring 2022 release) or later to use kKiosk mode.** You can't restrict users of the mobile app from signing out of the app. 

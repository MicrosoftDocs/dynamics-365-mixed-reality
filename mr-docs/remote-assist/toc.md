...
#### [Vendors and contractors use Dynamics 365 Remote Assist](vendor-use-RA.md)
...
#### [Calls between Remote Assist mobile users (preview)](mobile-app/remote-assist-mobile-to-remote-assist-mobile-calls.md)
#### [Calls between Remote Assist mobile & Teams users](mobile-app/remote-assist-mobile-to-teams-calls.md)
#### [Group calls with Remote Assist mobile (preview)](mobile-app/group-calling.md)

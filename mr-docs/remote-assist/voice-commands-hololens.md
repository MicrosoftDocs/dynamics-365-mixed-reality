...
|Toggle hand rays                       | Turn hand rays on or off. Note that turning hand rays off disables far-field interactions. Activating any tools that reqruie far-field interations (inking and arrows, for example) automatically turns hand rays back on.                                                                                         |
|Hand rays on                           | Show hand rays                                                                                                    |
|Hand rays off                          | Hide hand rays. Note that turning hand rays off disables far-field interactions. Activating any tools that reqruie far-field interations (inking and arrows, for example) automatically turns hand rays back on.                                                                                                    |
|**Call management**  | | 
|Call                                   |Call a contact                                                                                                     |

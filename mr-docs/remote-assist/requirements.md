...
> [!Note] 
> Dynamics 365 Remote Assist may not be available in your country. For more information, see [Dynamics 365 Remote Assist mobile availability](./mobile-app/faq-mobile.md#what-countries-is-dynamics-365-remote-assist-for-mobile-supported).
...
| ------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| None                                                                                                                           | - Teams desktop user can join a call using a [one-time call link](one-time-call.md) </br> - Teams desktop user can [join a meeting](./teams-pc-all.md#join-a-teams-meeting--with-dynamics-365-remote-assist-hololens-user-only) that allows anonymous participants </br> -  Use mixed-reality annotations                                                                                                                                                                                                                                                                                                                                                                                                                                                |

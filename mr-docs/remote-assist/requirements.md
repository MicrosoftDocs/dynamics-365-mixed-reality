...
\*\*The Teams license that is included with a Remote Assist license enables Remote Assist users to collaborate with Teams users and use most Remote Assist features. However, some features, such as sharing files from OneDrive and saving snapshots to OneDrive, require an Office 365 license. To use all Remote Assist features, a Remote Assist user must use the Teams license that is included with a [Office 365 Business Premium or Office 365 Business Essentials license](https://products.office.com/en-us/compare-all-microsoft-office-products?&activetab=tab:primaryr2).

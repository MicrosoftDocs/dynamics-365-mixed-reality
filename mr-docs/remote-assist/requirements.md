...
\*\*When you use the Teams license that is included with a Remote Assist license with included with Teams access, access to the following features is disabled: OneDrive, Snapshot URL. When you use the Teams license that is included with a [Office 365 Business Premium or Office 365 Business Essentials](https://products.office.com/en-us/compare-all-microsoft-office-products?&activetab=tab:primaryr2), you will have full access to all Remote Assist features.

...
Base Type: [crmbaseentity](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/crmbaseentity?view=dynamics-ce-odata-9)
...
|Name|Type|Partner|
|----------|-----------|------------|
|createdby|[systemuser](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/systemuser?view=dynamics-ce-odata-9)|lk_msdyn_customerassetattachment_createdby|
|createdonbehalfby|[systemuser](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/systemuser?view=dynamics-ce-odata-9)|lk_msdyn_customerassetattachment_createdonbehalfby|
|modifiedby|[systemuser](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/systemuser?view=dynamics-ce-odata-9)|lk_msdyn_customerassetattachment_modifiedby|
|modifiedonbehalfby|[systemuser](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/systemuser?view=dynamics-ce-odata-9)|lk_msdyn_customerassetattachment_modifiedonbehalfby|
|msdyn_customerasset|[msdyn_customerasset](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/msdyn_customerasset?view=dynamics-ce-odata-9)|msdyn_msdyn_customerasset|
|ownerid|[principal](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/principal?view=dynamics-ce-odata-9)|owner_msdyn_customerassetattachment|
|owningbusinessunit|[businessunit](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/businessunit?view=dynamics-ce-odata-9)|business_unit_msdyn_customerassetattachment|
|owningteam|[team](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/team?view=dynamics-ce-odata-9)|team_msdyn_customerassetattachment|
|owninguser|[systemuser](https://docs.microsoft.com/en-us/dynamics365/customer-engagement/web-api/systemuser?view=dynamics-ce-odata-9)|user_msdyn_customerassetattachment|

...
5. In the **Manage roles** dialog box, make sure the **Remote Assist - App User** role is selected.

     ![XXX.](media/restricted-mode-assets-selected-role.jpg "XXX")

6. In the **Manage roles** dialog box, make sure that the following roles are not selected:

...
> [!NOTE]
> Dynamics 365 Remote Assist supports the Teams lobby on HoloLens. A Dynamics 365 Remote Assist user in HoloLens joining a meeting might have to wait in the lobby until a meeting participant admits them. In that case, the user will see the message "Someone in the meeting should let you in soon." 

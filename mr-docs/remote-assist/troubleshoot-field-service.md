...
- A Microsoft Azure tenant with a Dynamics 365 subscription **and** a [!include[pn-dyn-365-remote-assist](../includes/pn-dyn-365-remote-assist.md)] subscription. Both are required—[!include[pn-remote-assist](../includes/pn-remote-assist.md)] is not included in any Dynamics 365 bundle.

...
# MICROSOFT SOFTWARE LICENSE TERMS<br>MICROSOFT DYNAMICS 365 REMOTE ASSIST iOS MOBILE
...
>   on iOS-based devices that you own or control in order to access and interact
>   with the Microsoft Dynamics 365 Remote Assist service to which you have
>   access rights via your company’s Microsoft Dynamics 365 Remote Assist
>   subscription (the terms of which you must comply with) or a one-time call
>   link provided to you by an authorized user. If you receive a one-time call
>   link it will enable your participation in a single a Microsoft Dynamics 365
>   Remote Assist call and you will not have continued access to join Remote
>   Assist calls by using the software.
>
>   **b) Required Microsoft Applications.** Use of the software requires a
>   license for Microsoft Dynamics 365 Remote Assist unless you are qualified as
>   an External User as defined in the Online Service Terms published at
...
>   Regulation Terms in the Attachment 3 of the Microsoft Online Services Data
>   Protection Addendum published at <https://aka.ms/DPA>.
...
**5. VIDEO CODECS.** This software may include H.264/AVC, VC-1, MPEG-4 Part 2,
and MPEG-2 visual compression technology. MPEG LA, L.L.C. requires this notice:
...
OR (ii) DECODE AVC, VC-1, AND MPEG-4 PART 2 VIDEO THAT WAS ENCODED BY A CONSUMER
ENGAGED IN A PERSONAL AND NON-COMMERCIAL ACTIVITY OR WAS OBTAINED FROM A VIDEO
PROVIDER LICENSED TO PROVIDE SUCH VIDEO. NO LICENSE IS GRANTED OR SHALL BE
IMPLIED FOR ANY OTHER USE. ADDITIONAL INFORMATION MAY BE OBTAINED FROM MPEG LA,
L.L.C. SEE <https://aka.ms/mpegla>.
...
**12. THIRD PARTY BENEFICIARY.** You agree that Apple and its subsidiaries are
third party beneficiaries of this agreement, and Apple has the right to enforce
this agreement.

**13. APPLICABLE LAW AND PLACE TO RESOLVE DISPUTES.** If you acquired the
...
**14. CONSUMER RIGHTS; REGIONAL VARIATIONS.** This agreement describes certain
...
**15. DISCLAIMER OF WARRANTY. THE SOFTWARE IS LICENSED “AS-IS.” YOU BEAR THE
...
**16. LIMITATION ON AND EXCLUSION OF REMEDIES AND DAMAGES. IF YOU HAVE ANY BASIS
...
Covered Parties or Apple knew or should have known about the possibility of the

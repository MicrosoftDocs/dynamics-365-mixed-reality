...
With Microsoft Dynamic 365 Layout, you can work with floor plans created with Microsoft Visio or you can create the layout with HoloLens. You can use the Dynamics 365 Import Tool (Preview) to make either type of layout available for immersive headsets. 

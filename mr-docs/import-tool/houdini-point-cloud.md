...
3.	Double-click in the center of **file1** icon (or press **I**) to drill down to the file selection part of this node, and then select the **File Chooser** button and choose the file you want to import.

...
**C.**	If you save your model as one of the file formats with a red asterisk next to it, you can optimize the 3D model yourself and use the [!include[pn-dyn-365-import-tool](../includes/pn-dyn-365-import-tool.md)] to convert the 3D model to a GLB locally. If you use any of the listed formats, including those with the red asterisks, you can use the [!include[pn-dyn-365-import-tool](../includes/pn-dyn-365-import-tool.md)] to send your model to [!include[cc-microsoft](../includes/cc-microsoft.md)] for manual optimization and conversion to a supported format.<br>

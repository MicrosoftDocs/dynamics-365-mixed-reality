...
2. If your organization has multiple Azure subscriptions, you can select which subscription you are viewing from the __Subscriptions__ drop-down in the __Directory & Subscriptions__ menu in the upper-right corner of the page.

...
# Set up Dyanmics 365 Product Visualize (in preview)

Microsoft Dynamics 365 Product Visualize requires an active Dynamics 365 for Sales instance that is backed by a SharePoint site. This document provides the step-by-step procedure for setting up a new trial instance. Once the instance is running, refer to the __Product Visualize Admin Guide__ for instructions on adding Users, Products, Opportunities, and Models.

## Create a new organization
This section is going to walk you through the creation of a new Azure Active Directory organization. This will give you a safe environment to try out Product Visualize that won't interfere with any existing Dynamics 365 instances. This new organization allows you to create and manage users separate from your business organization.

1. Login to the Azure portal at \([https://ms.portal.azure.com](https://ms.portal.azure.com))

2. If your organization has multiple Azure subscriptions you can select which subscription you are viewing from the __Subscriptions__ dropdown in the __Directory & Subscriptions__ menu in the upper right corner of the page

> <img width="40" height="40" style="vertical-align:middle; padding-top:5px; padding-bottom:5px" src="data:image/png;base64,"> The __Directory & Subscriptions__ can be accessed by clicking this icon

...
<!--from editor: Is there a reason why "Product" is capitalized in both mentions in the note? It looks like a generic reference to a product, so wouldn't need to be capitalized.-->

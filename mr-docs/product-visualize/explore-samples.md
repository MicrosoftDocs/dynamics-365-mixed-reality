...
4.	Place the model as described in the [Manipulate 3D models topic](manipulate-models.md), and then size, rotate, move, or lift the model.

5.	Add notes as described in the [Add a note to your 3D model topic](add-note.md). Notes will not be saved when you close the Product Visualize app. 
